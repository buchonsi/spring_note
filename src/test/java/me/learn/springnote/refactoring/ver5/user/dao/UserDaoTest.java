package me.learn.springnote.refactoring.ver5.user.dao;

import me.learn.springnote.refactoring.ver5.user.domain.User;
...
class UserDaoTest {
    ...
    void count_test() throws SQLException, ClassNotFoundException {
        ApplicationContext context = new GenericXmlApplicationContext("config/refactoring/ver5/applicationContext.xml");
